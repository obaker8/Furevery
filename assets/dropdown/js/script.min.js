...
<head>
  ...
  <link rel="shortcut icon" href="assets/images/hexagrologo-copy-128x128-11.png" type="image/x-icon">
  ...
  <link rel="stylesheet" href="assets/dropdown/css/style.css">jQuery(function(t){function e(e){"resize"===e.type&&(t(h.BODY).removeClass(a.DROPDOWN_OPEN),t(h.BASE).removeClass(a.OPENED).find(h.TOGGLER).each(function(){t(t(this).attr("data-target")).removeClass(a.IN).add(this).attr("aria-expanded","false")}))
            ...
            <div class="mbr-table">
                <div class="mbr-table-cell">
                    ...
                    <div class="navbar-brand">
                        <a href="index.html" class="navbar-logo"><img src="assets/images/hexagrologo-copy-128x128-11.png" alt="furevery"></a>
                ...
                <div class="mbr-table-cell">
                    ...
                    <ul class="nav-dropdown collapse pull-xs-right nav navbar-nav navbar-toggleable-sm" id="exCollapsingNavbar"><li class="nav-item"><a class="nav-link link" href="index.html" aria-expanded="false">HOME</a></li><li class="nav-item"><a class="nav-link link" href="business.html" aria-expanded="false">ADD YOUR BUSINESS</a></li><li class="nav-item"><a class="nav-link link" href="download.html" aria-expanded="false">DOWNLOAD</a></li><li class="nav-item"><a class="nav-link link" href="blog.html" aria-expanded="false"><p>DOG BLOG</p></a></li><li class="nav-item"><a class="nav-link link" href="story.html" aria-expanded="false">OUR STORY</a></li><li class="nav-item"><a class="nav-link link" href="contact.html" aria-expanded="false">CONTACT</a><a class="nav-link link" href="more.html" aria-expanded="false"><p>MORE</p></a></li></ul>
...
<section class="mbr-section mbr-section-hero mbr-section-full mbr-parallax-background" id="header1-1" style="background-image: url(assets/images/landscape-1439490128-plants-2000x1000-14.jpg);">

    <div class="mbr-overlay" style="opacity: 0.4; background-color: rgb(37, 90, 55);"></div>
        ...
        <div class="container">
            <div class="row">
                <div class="mbr-section col-md-10 col-md-offset-1 text-xs-center">
                    ...
                    <h1 class="mbr-section-title display-1">furevery coming soon</h1>
                    <p class="mbr-section-lead lead"><span style="font-style: normal;">to app store and google play</span><br></p>
                    <div class="mbr-section-btn"><a class="btn btn-lg btn-black" href="contact.html">contact us</a> <a class="btn btn-lg btn-white btn-white-outline" href="story.html">our story</a></div>
                </div>
            </div>
        </div>
    </div>
...
Phone: +1 (519) 591 1843<br></p>
            ...
            <div class="mbr-footer-content col-xs-12 col-md-3"><strong>Links</strong><ul><li>add your business</li><li>download</li><li>dog blog</li><li>our story</li><li>contact</li><li>more</li></ul></div>
            <div class="col-xs-12 col-md-6">
                <div class="mbr-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=place_id:EiwxMSBQZWFjZSBEciwgU2NhcmJvcm91Z2gsIE9OIE0xRyAyVjMsIENhbmFkYQ" allowfullscreen=""></iframe></div>
            </div>
        </div>
    </div>
</section>
...
<footer class="mbr-small-footer mbr-section mbr-section-nopadding" id="footer1-2" style="background-color: rgb(50, 50, 50); padding-top: 1.75rem; padding-bottom: 1.75rem;">
    ...
    <div class="container">
        <p class="text-xs-center">Copyright (c) 2017 furevery</p>
    </div>
</footer>
